...
public class LocationData
{
    ...
    //проверим инициализировались ли уже переменные
	public static synchronized boolean locationIsNull(){
		if(LocationData.latitudeGPS!=null && 
		   LocationData.longitudeGPS!=null && 
		   LocationData.altitudeGPS!=null){
			return false;
		}
		return true;
	}
