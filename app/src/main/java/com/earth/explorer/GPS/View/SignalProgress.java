...
public class SignalProgress extends View implements SharedConstants
{
	...
	public void init()
	{
		...
		paintUsedInFix.setColor(Color.parseColor("#64B5F6"));//был #2d84ff
		...
		paint = new Paint();
		paint.setColor(Color.parseColor("#448AFF"));//#448AFF
	...
	{
		super.onDraw(canvas);
		//drawSignalProgress(canvas);//рисуем 
		
		//if(GPSActivity.hasPermission()){
		...
		//if(provider!=null){//if(provider!=null){
			...
			/*if(GPSActivity.provider.equals("")){
	...
	public void setDbHz(){
		...
		if(MyService. gnssStatusCallback. arraySat!=null){//1*

			for (MySatellite s : MyService. gnssStatusCallback. arraySat) {//2*
